    ...
    try {
      ...
      if (status !== "granted") {
        ...
        if (newStatus !== "granted") {
          Alert.alert("Location Permission Required", "Location permission is required for the app to function correctly. Please enable it in app settings.", [
            {
              text: "Cancel",
              style: "cancel",
            },
      ...
      if (!providerStatus.locationServicesEnabled) {
        ...
        try {
          ...
          if (locationError.code === "E_LOCATION_SERVICES_DISABLED" || locationError.message?.includes("location") || locationError.message?.includes("disabled")) {
            const newProviderStatus = await Location.getProviderStatusAsync();
            if (!newProviderStatus.locationServicesEnabled) {
              Alert.alert("Location Services Required", "Location services are still disabled. Please enable location services in your device settings to continue.", [
                {
                  text: "Cancel",
                  style: "cancel",
                },
    ...
    try {
      ...
      if (foregroundStatus === "granted") {
        ...
        if (backgroundStatus === "granted") {
          ...
          Alert.alert("Background Location Required", "All-time location permission is required for the app to function correctly.", [
            {
              text: "Cancel",
              style: "cancel",
            },
        ...
        Alert.alert("Permission Required", "Location permission is required for the app to work. Please enable it in settings.", [
          {
            text: "Cancel",
            style: "cancel",
          },
      ...
      >
        <View style={styles.overlay}>
          <View style={styles.modalContainer}>
            ...
            <TouchableOpacity style={styles.button} onPress={content.action} activeOpacity={0.7}>

  ...
  (
    ...
    return (
      <BottomSheet
        ...
        {...otherProps}
      >
        {scrollable ? <BottomSheetScrollView contentContainerStyle={[styles.scrollContentContainer, contentContainerStyle]}>{children}</BottomSheetScrollView> : <BottomSheetView style={[styles.contentContainer, contentContainerStyle]}>{children}</BottomSheetView>}
      </BottomSheet>
    );
  }
);

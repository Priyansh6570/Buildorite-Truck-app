...
const LocationInput = ({ onLocationSelect }) => {
      ...
      <Modal animationType="fade" visible={modalVisible}>
        <View className="flex-1 bg-gray-900">
          ...
          <View className="flex-row items-center justify-center px-8 py-12 bg-gray-900">
            ...
            <Text className="ml-8 text-3xl font-black text-white">
  ...
  <View className="p-5 mx-2 bg-[#2C3441] bg-opacity-50 border border-slate-500 rounded-3xl">
    ...
    {/* List of Reasons */}
    <View>
      {/* Item 1: Correct Delivery */}
      <View className="flex-row items-start mb-3">
        <View className="items-center w-6 pt-1 mr-2">
          <FontAwesome5 name="truck" size={16} color="white" />
        </View>
        <Text className="flex-1 ml-2 text-sm leading-5 text-gray-300">
          To ensure your materials are delivered to the correct location.
        </Text>
      </View>

      {/* Item 2: Accurate Charges */}
      <View className="flex-row items-start">
         <View className="items-center w-6 pt-1 mr-2">
          <MaterialIcons name="calculate" size={20} color="white" />
        </View>
        <Text className="flex-1 ml-2 text-sm leading-5 text-gray-300">
          To calculate accurate delivery charges based on distance.
        </Text>
      </View>
    </View>
  </View>
          ...
          <View className="flex-1 p-6 mt-4 bg-white">
              ...
              <View className="flex-row items-start mb-6">
                ...
                <View className="flex-1">
                  ...
                  <Text className="text-lg text-gray-500">
                    Type to find your mine location
                  </Text>
                </View>
              </View>
                    ...
                    <View className="flex-row items-center justify-between w-full p-6 my-1 overflow-hidden bg-white border shadow-sm border-slate-100 rounded-2xl">
                      <View className="flex-row items-center space-x-4">
                        ...
                        <View className="overflow-hidden w-[200px]">
                          <Text className="text-lg font-bold text-gray-800 text-ellipsis">
            ...
            <View
              className="overflow-hidden border border-blue-300 rounded-3xl"
              style={{ zIndex: 1 }}
            >
              <LinearGradient
                ...
                className="items-center p-10 px-12 text-center"
              >
                ...
                <Text className="text-lg text-center text-gray-600">
                  Search and select the exact location of your mine
                </Text>
              </LinearGradient>
            </View>
          </View>

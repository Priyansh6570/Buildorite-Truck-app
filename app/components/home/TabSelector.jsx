  ...
  return (
    <View className="px-6 relative top-[-20px] mt-12">
      ...
      activeOpacity={1}
        ...
        >
          <Text className={`font-semibold text-lg ${selectedTab === "mines" ? "text-white" : "text-gray-600"}`}>
            Mines
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text className={`font-semibold text-lg ${selectedTab === "materials" ? "text-white" : "text-gray-600"}`}>
            Materials
          </Text>
        </TouchableOpacity>
      </View>

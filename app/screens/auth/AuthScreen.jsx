  ...
  const renderOtpInputView = () => (
    <View>
      <View className="p-10 mt-6 bg-white border rounded-3xl border-slate-100" style={{ elevation: 5, shadowColor: "#00000050" }}>
        ...
        {userData?.userExists && <Text className="mb-6 text-2xl font-bold text-center text-gray-800">Welcome back, {userData.name || "User"}!</Text>}
        ...
        <TouchableOpacity onPress={handleOtpSubmit} disabled={otp.length !== 6 || isVerifying} className={`mt-6 p-5 rounded-2xl items-center justify-center ${otp.length !== 6 || isVerifying ? "bg-gray-400" : "bg-[#1C2533]"}`} style={{ elevation: 3, shadowColor: "#000" }}>

...
// Trip Stage Flow Component for Driver
          ...
          <View className="items-center mr-3">
            <View 
              className={`items-center justify-center w-10 h-10 rounded-full ${
                item.yourAction ? 'bg-orange-200' : 
                item.action === 'wait' ? 'bg-gray-200' : 'bg-blue-200'
              }`}
            >
              <Ionicons 
                name={item.icon} 
                size={18} 
                color={
                  item.yourAction ? '#f97316' : 
                  item.action === 'wait' ? '#6b7280' : '#3b82f6'
                } 
              />
            </View>
              ...
              {item.canNavigate && (
                <View className="px-2 py-1 bg-green-100 rounded-full">
                  <Text className="text-xs font-bold text-green-700">
                    NAV TO {item.canNavigate === 'mine' ? 'MINE' : 'DELIVERY'}
                  </Text>
                </View>
              )}
            </View>
        ...
        },
        {
          ...
          component: (
            <View className="my-3">
              <PermissionItem
                icon="location"
                title="Location Permission (All Time)"
                description="Critical for live trip tracking, navigation assistance, and real-time location updates during active trips"
                color="#ef4444"
                important={true}
              />
              <PermissionItem
                ...
                description="Essential for receiving trip assignments, stage updates, and important communications from truck owners"
                color="#3b82f6"
                important={true}
              />
            </View>
          ...
          component: (
            <View className="p-4 my-3 border border-blue-200 bg-blue-50 rounded-xl">
              ...
              <View className="space-y-2">
                <Text className="mb-2 text-sm text-blue-800">• <Text className="font-semibold">Bottom Tab Navigation:</Text> Use "Trips" tab for full trip management</Text>
                <Text className="text-sm text-blue-800">• <Text className="font-semibold">Profile Screen:</Text> Quick access to assigned trips from your profile</Text>
              </View>
            </View>
          )
        },
        ...
        },
        {
          ...
          component: (
            <View className="p-4 my-3 border border-orange-200 bg-orange-50 rounded-xl">
              ...
              <View className="space-y-2">
                <Text className="mb-2 text-sm text-orange-800">• <Text className="font-semibold">Trip Started:</Text> Mark when you begin journey to pickup</Text>
                <Text className="mb-2 text-sm text-orange-800">• <Text className="font-semibold">Arrived at Pickup:</Text> Confirm arrival at mine location</Text>
                <Text className="mb-2 text-sm text-orange-800">• <Text className="font-semibold">Loading Complete:</Text> Mark when materials are loaded</Text>
                <Text className="mb-2 text-sm text-orange-800">• <Text className="font-semibold">En Route to Delivery:</Text> Start journey to destination</Text>
                <Text className="mb-2 text-sm text-orange-800">• <Text className="font-semibold">Arrived at Delivery:</Text> Confirm arrival at delivery point</Text>
                <Text className="text-sm text-orange-800">• <Text className="font-semibold">Delivery Complete:</Text> Mark when unloading is finished</Text>
              </View>
            </View>
          )
        },
          ...
          component: (
            <React.Fragment>
              ...
              <Text className="mt-2 text-sm text-gray-600">
                The Schedule screen displays a calendar view with highlighted dates showing different types of trips and their status.
              </Text>
            </React.Fragment>
          )
        },
      ...
      items: [
        {
          ...
          component: (
            <React.Fragment>
              ...
              <Text className="mt-2 text-sm text-gray-600">
                Update your name, email address, and phone number to ensure smooth communication with truck owners and support.
              </Text>
            </React.Fragment>
          )
        },
        {
          ...
          component: (
            <React.Fragment>
              ...
              <StepByStep 
                title="Vehicle Details to Update"
                steps={[
                  'Vehicle model and make for identification',
                  'Registration number for official documentation',
...
Thank you!`;
  ...
  const showVideoMessage = () => {
    Alert.alert(
      'Video Tutorials',
      'Video tutorials for drivers are not available yet. We\'re working on creating helpful video content for trip management and navigation!',
      [{ text: 'OK' }]
    );
  };
  ...
  const showUserGuide = () => {
    Alert.alert(
      'User Guide',
      'Comprehensive driver guide with detailed screenshots and step-by-step instructions coming soon!',
      [{ text: 'OK' }]
    );
  };
          ...
          <View className="p-6 mt-8 border-2 border-blue-200 bg-blue-50 rounded-2xl">
            <View className="items-center">
              ...
              <Text className="mt-2 text-center text-blue-700">
                Our support team is here to help you with your driving assignments and trip management.
              </Text>
